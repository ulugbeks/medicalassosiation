...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Static Page</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Add New Static Page</h3>
                        </div>
                        <form id="static-page-form" action="{{ route('static-pages.store') }}" method="POST" data-ajax="true">
                            @csrf
                            <div class="card-body">
                                @if($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted">URL-friendly identifier (e.g., terms-conditions)</small>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                        ...
                                        <div class="tab-content" id="language-content">
                                            @foreach($languages as $index => $language)
                                                <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" 
                                                    ...
                                                    <div class="form-group">
                                                        <label for="title_{{ $language->code }}">Title ({{ $language->name }}) <span class="text-danger">*</span></label>
                                                        <input type="text" 
                                                               class="form-control" 
                                                    ...
                                                    <div class="form-group">
                                                        <label for="content_{{ $language->code }}">Content ({{ $language->name }}) <span class="text-danger">*</span></label>
                                                        <textarea class="form-control rich-editor" 
                                                                  id="content_{{ $language->code }}" 
                                                                  name="content[{{ $language->code }}]" 
                                                                  rows="15" 
                                                                  required>{{ old('content.'.$language->code) }}</textarea>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="seo_title_{{ $language->code }}">SEO Title ({{ $language->name }})</label>
                                                        <input type="text" 
                                                               class="form-control" 
                                                    ...
                                                    <div class="form-group">
                                                        <label for="seo_description_{{ $language->code }}">SEO Description ({{ $language->name }})</label>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-success" id="save-btn">
                                    <i class="fas fa-save"></i> <span class="btn-text">Create Page</span>
                                </button>
                                <a href="{{ route('static-pages.index') }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
