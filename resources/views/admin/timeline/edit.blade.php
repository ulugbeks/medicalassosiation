                            ...
                            <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('title.'.$language->code, $timeline->getTranslation('title', $language->code, false)) }}" 
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <textarea name="description[{{ $language->code }}]" 
                                              ...
                                              rows="3">{{ old('description.'.$language->code, $timeline->getTranslation('description', $language->code, false)) }}</textarea>
